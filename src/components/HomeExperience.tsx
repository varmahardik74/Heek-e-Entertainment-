...
export default function HomeExperience() {
  return <div className="home-page">
    ...
    <section className="trust-strip"><Reveal className="container-shell"><p className="section-kicker">TRUSTED BY THE WORLD&apos;S FASTEST-GROWING COMPANIES</p><div className="logo-marquee"><div className="logo-track"><span>HYPERION</span><span>RAMP</span><span>CONDUIT</span><span>FLODESK</span><span>VERCEL</span><span>HYPERION</span><span>RAMP</span><span>CONDUIT</span></div></div></Reveal></section>
